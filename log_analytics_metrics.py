...
def main():
    ...
    #startprint(query_ids)
    logger = initialize_logger()
    client = initialize_query_client()
    start_time = datetime.strptime(content['analytics']['start_time'], "%Y-%m-%dT%H:%M:%SZ")
    end_time = datetime.strptime(content['analytics']['end_time'], "%Y-%m-%dT%H:%M:%SZ")

    print(start_time)
    print(end_time)

    workspace_id=content['analytics']['workspace_id']
    print(workspace_id)

    #print(content['analytics'] ['metrics'])
    #print(content['analytics'] ['metrics_cust'])

    metrics_to_query = content['analytics'] ['metrics']
    metrics_to_custom = content['analytics'] ['metrics_cust']
